...
{
    class TwoRovers : Event
    {
        public static bool classSpawned = false;

        public TwoRovers(world worldParent, tile tileParent)
        ...
        public TwoRovers(Event eventParent) : base(eventParent)
        {
            spawned = classSpawned;
            eventChildren.Add(new ThreeRovers(this));
            item = new Weapon("Cannon","CAN");
            chance = .50;
            id = 4;
        }
